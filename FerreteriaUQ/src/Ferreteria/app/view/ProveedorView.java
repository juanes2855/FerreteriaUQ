	...
	public ProveedorView(Composite parent, int style) {
		...
		btnEliminarProveedor.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (proveedorSeleccionado != null) {
					if (!crudProveedorViewController.consultarSiExiste(proveedorSeleccionado)) {
				     ...
				     if(variable==0){
						...
						crudProveedorViewController.guardarArchivoLog(
								"Se ha eliminado el proveedor: " + proveedorSeleccionado.getNombreProveedor(), 2,
								"ProveedorEliminado");
				     }else{
				    	 flag=false;
				     }
						...
						try {
							...
							crudProveedorViewController.guardarArchivoLog(
											"El proveedor seleccionado esta vinculado con una transacción: "
													+ proveedorSeleccionado.getNombreProveedor()+" ",
											2, "ProveedorVinculado");
							JOptionPane.showMessageDialog(null, "No se pudo eliminar, el proveedor esta relacionado con una "
									+ "transacción.");
						}
					}
				}
		...
		table.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				codigoAnterior = proveedorSeleccionado.getCodigoProveedor();
			}
		});
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (verificarCamposVacios() == true) {
					...
					try {
						...
						crudProveedorViewController.guardaDatosTextoPlano();
						crudProveedorViewController.guardarArchivoLog(
								"Se ha añadido el proveedor: " + prooNuevo.getNombreProveedor(), 2, "ProveedorAñadido");
					} catch (yaExiste e1) {
						...
						JOptionPane.showMessageDialog(null, "No se aceptan letras en código y telefono", null,
				...
				if (proveedorSeleccionado != null) {
					try {
						crudProveedorViewController.actualizarProveedor(textNombre.getText(),
								...
								textDireccion.getText(), codigoAnterior);
						crudProveedorViewController.salvarDatos();
						crudProveedorViewController.guardaDatosTextoPlano();
						crudProveedorViewController.guardarArchivoLog(
								"Se ha modificado el proveedor: " + proveedorSeleccionado.getNombreProveedor(), 2,
								"ProveedorModificado");
